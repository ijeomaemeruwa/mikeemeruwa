...
const Intro = () => {
    ...
    <div className="flex flex-col justify-center mx-auto items-center h-full pt-2 lg:pt-11">
      ...
      <h1 className="w-11/12 md:w-4/6 text-2xl md:text-4xl xl:text-6xl text-center font-extrabold text-white font-poppins tracking-wider">
        A multimedia content curator with a passion for storytelling
      </h1> 

      <p 
        className="flex text-center text-grey items-center text-base font-semibold font-poppins tracking-wider pt-10 border-b border-grey hover:text-white hover:border-white" 
        style={{width: '133px'}}
      >
